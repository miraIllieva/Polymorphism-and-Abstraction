...
print(len(first_group))  # Expected: 3
print(second_group)  # Expected: Group Special with members Elon Musk, Warren Musk
print(third_group[0])  # Expected: Person 0: Aliko Dangote
